...
LATLON_data <- read.csv("../data_files/Eocene_latlon_corals.csv", sep = ";") # file containing coordinates of the Eocene coral occurrences
Yaxis <- rep(1, length(LATLON_data$PALEO.LAT..Scotese.))  # y set to 1, because the y-axis is not meaningful for 'occurrence'
...
plot_fig1 <- ggplot() +
  ...
  geom_point(data = LATLON_data, aes(x = PALEO.LAT..Scotese., y = Yaxis), shape = 22, color = "coral", size=3) + 
...
# pdf("FIGURE1_CORAL_PAPER.pdf", width = 15, height = 10)
# print(plot_fig1)
# dev.off()
